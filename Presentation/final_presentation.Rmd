...
```{r ,warning=FALSE,echo=FALSE,out.width='63%',fig.align='center',echo=FALSE,fig.cap="Figure: Comparison Kernels estimated assuming different priors for sharp images (Nandy et al.) "}
